const problems = [
    ...
    {name: "Number of Islands", done: 1},
    {name: "Design File System", done: 0},
    {name: "LRU Cache", done: 1},
    ...
    {name: "Longest Palindromic Substring", done: 1},
    ...
    {name: "Subtree of Another Tree", done: 1},
    ...
    {name: "Lowest Common Ancestor of BST", done: 1},
